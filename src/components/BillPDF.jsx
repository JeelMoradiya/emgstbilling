      ...
      <Page size="A4" style={styles.page}>
        <View style={styles.header}>
          <View>
            ...
            <Text style={styles.subtitle}>Company: {safeUser.companyName}</Text>
            <Text style={styles.subtitle}>Address: {safeUser.address}</Text>
        ...
        <View style={styles.section}>
          <View style={styles.row}>
            <View>
              <Text style={{ fontWeight: 'bold', marginBottom: 6, color: '#0288d1' }}>
                Billed To:
              </Text>
              <Text>{safeBill.partyDetails.partyName || 'N/A'}</Text>
              <Text>{safeBill.partyDetails.address || 'N/A'}</Text>
        ...
        <View style={styles.amountSection}>
          ...
          <View style={styles.amountBox}>
            ...
            <View style={styles.totalRow}>
              <Text style={{ fontWeight: 'bold', color: '#0288d1' }}>Total:</Text>
              <Text style={{ fontWeight: 'bold', color: '#0288d1' }}>
